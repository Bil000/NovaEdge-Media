    ...
    <section className="text-center mx-auto px-4 py-16 md:py-24">
      ...
      >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8, delay: 0.2 }}
          className="h-[16em] w-[17em] flex justify-center items-center flex-col bg-gradient-to-r from-blue-500 to-purple-600 p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all text-center w-60"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8, delay: 0.2 }}
          className="h-[16em] w-[17em] flex justify-center items-center flex-col bg-gradient-to-r from-green-400 to-blue-500 p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all text-center w-60"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8, delay: 0.2 }}
          className="h-[16em] w-[17em] flex justify-center items-center flex-col bg-gradient-to-r from-pink-500 to-red-600 p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all text-center w-60"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8, delay: 0.2 }}
          className="h-[16em] w-[17em] flex justify-center items-center flex-col bg-gradient-to-r from-yellow-400 to-orange-500 p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all text-center w-60"
        >
