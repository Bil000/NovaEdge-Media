...
export default function Home() {
  ...
  const [transitioning, setTransitioning] = useState(false); // Track the transition stat
  ...
  return (
    ...
    <section
      className="md:rounded-t-md mx-[5px] text-center px-2 lg:px-6 pb-16 bg-[url('/headergif1.gif')] lg:bg-[url('/headergif.gif')]"
